    ...
    function (
        ...
        return Component.extend({
            ...
            getMinLimit: function () {
                return priceUtils.formatPrice(window.checkoutConfig.payment.tamara_pay_by_instalments_6.min_limit);
            },

            getMinLimitAmount: function () {
                return window.checkoutConfig.payment.tamara_pay_by_instalments_6.min_limit;
            },

            getMaxLimit: function () {
                return priceUtils.formatPrice(window.checkoutConfig.payment.tamara_pay_by_instalments_6.max_limit);
            },

            getMaxLimitAmount: function () {
                return window.checkoutConfig.payment.tamara_pay_by_instalments_6.max_limit;
            },

            isTotalAmountInLimit: function () {
                var tamaraConfig = window.checkoutConfig.payment.tamara_pay_by_instalments_6;
